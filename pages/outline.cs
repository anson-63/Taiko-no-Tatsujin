...
namespace Taiko.pages // Note the capital P to match XAML xmlns
{
    ...
    public class OutlinedTextBlock : FrameworkElement
    {
        ...
        public static readonly DependencyProperty TextDecorationsProperty =
            DependencyProperty.Register(nameof(TextDecorations), typeof(TextDecorationCollection), typeof(OutlinedTextBlock),
                new FrameworkPropertyMetadata(OnFormattedTextUpdated));
        ...
        {
            var c = (OutlinedTextBlock)d;
            c.formattedText = null;
            c.textGeometry = null;
            c.InvalidateMeasure();
            c.InvalidateVisual();
        }
